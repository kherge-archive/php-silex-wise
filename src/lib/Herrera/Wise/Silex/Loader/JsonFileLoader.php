...
use Herrera\Wise\Loader\JsonFileLoader as Base;
use Herrera\Wise\Silex\SilexAwareInterface;
use Silex\Application;

/**
 * Integrates Silex support into the JSON file loader.
 *
 * @author Kevin Herrera <kevin@herrera.io>
 */
class JsonFileLoader extends Base implements SilexAwareInterface
{
    /**
