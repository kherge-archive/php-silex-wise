...
use Herrera\Wise\Loader\IniFileLoader as Base;
use Herrera\Wise\Silex\SilexAwareInterface;
use Silex\Application;

/**
 * Integrates Silex support into the INI file loader.
 *
 * @author Kevin Herrera <kevin@herrera.io>
 */
class IniFileLoader extends Base implements SilexAwareInterface
{
    /**
